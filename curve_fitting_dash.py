...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            ], className="section-card-fitting-options"),
        ...
        html.Div([
            ...
            html.Div([
                ...
                dash_table.DataTable(
                    id="data-table",
                    columns=[
                        {"name": "X values", "id": "x", "type": "numeric", "editable": True},
                        {"name": "Y values", "id": "y", "type": "numeric", "editable": True},
                        #{"name": "Actions", "id": "actions", "presentation": "markdown"}
                    ],
                    #data=[{**point, "actions": "🗑️"} for point in initial_data],
                    editable=True,
                    row_deletable=True,
                    style_cell={"textAlign": "center", "backgroundColor": "rgba(255,255,255,0.1)", "color": "white", "fontSize": "18px"},
    ...
    <head>
        ...
        <style>
            * {
            ...
            .main-content {
                /* display: flex; */      # This line is problematic as it cause the plot to extend indefinitely
            ...
            /* section-card refers to each section on the sidebar, except for fitting options */
            ...
            .section-card-fitting-options{
                ...
                box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1);
                margin-bottom: 20px;
                z-index: 10;  /* higher z index to avoid hiding the dropdown */
            }
            ...
            .dropdown > div {
                background: rgba(255, 255, 255, 0.8);        /* careful on alpha transparency value */
                border: 1px solid rgba(255, 255, 255, 0.3);
                color: black;
                z-index: 10;
            }
...
def update_table(points_data):
    return [{**point} for point in points_data]
...
def update_chart_and_metrics(points_data, curve_type, poly_degree):
    ...
    fig.update_layout(
        ...
        xaxis={
            "title": {"text": "X Axis", "font": {"size": 18}},
            "tickfont": {"size": 14}
        },
        yaxis={
            "title": {"text": "Y Axis", "font": {"size": 18}},
            "tickfont": {"size": 14}
        },
        font=dict(color="white", size=16), # global font for other elements
    )
